...
const PatientRegistration = () => {
    ...
    const GetData = () => {
        AxiosInstanace.get(`patients/${MyId}`).then((res) => {
            ...
            setValue('emergency_contact', res.data.emergency_contact)
            setValue('medical_history', res.data.medical_history)
    ...
    {
        AxiosInstanace.put(`patients/${MyId}/`, {
            name: data.name,
        ...
        <div>
            <Box sx={{ display: 'flex', width: '100%', backgroundColor: '#00003f', marginBottom: '10px' }}>
                <Typography sx={{ marginLeft: '20px', color: '#fff' }}>
                   Edit Patients Registration Details
                </Typography>
            </Box>
